// Storing API endpoing as queryURL
var queryURL = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson";


// Performing a GET request to the query URL
d3.json(queryURL).then(function(data){
    // After response, send data.features and data.features object to createFeatures function.
...
function createFeatures(earthquakeData, platesData){
    ...
    // Giving each feature a popup describing the place and time of the earthquakes
    ...
    // Creating a variable for earthquakes to house latlng, each feature for popup, and cicrle radius/color/weight/opacity
